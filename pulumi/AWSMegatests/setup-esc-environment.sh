...
esc env set nf-core/AWSMegatestsProd/aws environmentVariables.AWS_SECRET_ACCESS_KEY '${aws.login.secretAccessKey}'
esc env set nf-core/AWSMegatestsProd/aws environmentVariables.AWS_SESSION_TOKEN '${aws.login.sessionToken}'
...
esc env set nf-core/AWSMegatestsProd/aws environmentVariables.GITHUB_TOKEN '${1password.secrets.github-token}'
esc env set nf-core/AWSMegatestsProd/aws environmentVariables.TOWER_ACCESS_TOKEN '${1password.secrets.tower-access-token}'
